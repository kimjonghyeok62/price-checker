...
// 안드로이드 크롬 '데스크톱 사이트'가 켜진 상태 (UA가 "X11; Linux x86_64"로 바뀌지만 터치 화면)
// 나이스 학원(넥사크로)은 이때 PC 화면을 띄우고, 모바일 화면을 강제로 지정해도 터치 입력이 동작하지 않는다.
export const isAndroidDesktopMode = () =>
